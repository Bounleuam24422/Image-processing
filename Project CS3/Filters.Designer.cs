namespace Project_CS3
{
	partial class Filters
	{
		...
		private void InitializeComponent()
		{
			...
			this.button14.Text = "Gaussian Sharpen";
			...
			this.button12.Text = "Color Correction";
			...
			this.button9.Text = "Polaroid Color";
			...
			this.button8.Text = "Black and White";
			...
			this.ClientSize = new System.Drawing.Size(1224, 901);
